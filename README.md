...
Если tModLoader пишет, что пространство имён и название папки не совпадают, значит в `ModSources` попала не та папка. Для сборки нужно копировать именно вложенную папку `DroneWarfare/`, а не весь каталог репозитория с GitHub. Подробная инструкция есть в [`INSTALLATION.md`](INSTALLATION.md).
